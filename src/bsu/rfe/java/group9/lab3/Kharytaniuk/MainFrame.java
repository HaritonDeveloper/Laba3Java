...
// манипулировать из разных мест
    ...
    public MainFrame(Double[] coefficients) {
        ...
        //Это сообщение будет отображаться на заголовке окна приложения.
        ...
        Action aboutInfoAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Шапель Никита, 6 группа", "О программе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
...
// предотвратить увеличение размера поля ввода
        ...
        // Создать текстовое поле для ввода значения длиной в 10 символов
// со значением по умолчанию 1.0
        textFieldStep = new JTextField("0.05", 10);
        // Установить максимальный размер равный предпочтительному, чтобы
// предотвратить увеличение размера поля ввода
